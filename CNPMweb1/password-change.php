                    ...
                    <div class="card-body p-4">
                         ...
                         <form action="password-reset-code.php" method = "POST">
                            ...
                            <div class="form-group mb-3">
                               ...
                               <input type="password" name="new_password" class="form-control"  placeholder = "Enter New Passsword">
                            </div>
                            <div class="form-group mb-3">
                               <label for="">Confirm Password</label>
                               <input type="password" name="confirm_password" class="form-control"  placeholder = "Enter Confirm Passsword">
                            </div>
                            <div class="form-group mb-3">
